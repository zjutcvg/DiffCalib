...
from diffcalib.spvcnn_utils import *
...
class SPVCNN_CLASSIFICATION(nn.Module):
    def __init__(self, **kwargs):
        ...
        # cs = [512, 512, 256, 128, 256, 256, 128, 96, 96]
        ...
        #     nn.Conv2d(in_channels=cs[4], out_channels=128, kernel_size=1),
    ...
    def forward(self, x):
        ...
        z2 = voxel_to_point(x2, z0, nearest=False)
