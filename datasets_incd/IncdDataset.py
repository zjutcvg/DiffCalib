...
from .HypersimDataset import HypersimDataset
from .VirtualKittiDataset import VirtualKittiDataset
...
def IncdDataset(
    ...
    for datasetname in datasets_included:
        ...
        elif datasetname == 'Hypersim':
            datasets[datasetname] = HypersimDataset(
                os.path.join(data_root, datasetname),
                ht=ht, wt=wt,
        ...
        elif datasetname == 'virtualkitti':
            datasets[datasetname] = VirtualKittiDataset(
                os.path.join(data_root, datasetname),
                ht=ht, wt=wt,
                augmentation=augmentation,
                shuffleseed=shuffleseed,
        ...
        elif datasetname == 'Taskonomy' or datasetname == 'ibims' or datasetname == 'DIODE_indoor':
            datasets[datasetname] = MetricDataset(
                os.path.join(data_root, datasetname),
                ht=ht, wt=wt,
                augmentation=augmentation,
                shuffleseed=shuffleseed,
